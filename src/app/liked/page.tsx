...
export default function LikedProductsPage() {
    ...
    const fetchLikedProducts = async () => {
      try {
        ...
        if (likedProducts && likedProducts.length > 0) {
          const productIds = likedProducts.map(item => item.product_id);
    ...
    return (
      <div className="container mx-auto px-4 py-24">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-brown mb-4">Connectez-vous pour voir vos produits likés</h1>
  ...
  return (
    <div className="container mx-auto px-4 py-24">
      <h1 className="text-4xl font-bold text-brown mb-8 text-center">Produits Likés</h1>
      
      {products.length === 0 ? (
        <div className="text-center">
          <p className="text-brown mb-4">Aucun produit liké pour le moment.</p>
